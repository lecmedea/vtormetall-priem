...
export default function AboutPage() {
  return <><Header /><main><PageHero eyebrow="О пункте" title="Нормальная приёмка" accent="без театра" lead="Наша задача простая: быстро понять, что вы привезли, прозрачно объяснить оценку и не превращать сдачу металла в бюрократический марафон." />
    ...
    <section className="section shell team-section" aria-labelledby="team-title">
      <div className="section-heading section-heading--row"><div><p className="eyebrow"><span /> Люди ВторМеталла</p><h2 id="team-title">Наша<br /><em>команда</em></h2></div><p>Ответственные за работу пункта и связь с клиентами — без обезличенного колл-центра.</p></div>
      <div className="team-grid">
        <article className="team-card"><div className="team-card__photo" role="img" aria-label="Куфтов Ярослав"><span>КЯ</span><small>ВторМеталл</small></div><h3>Куфтов Ярослав</h3><p>Генеральный директор</p></article>
        <article className="team-card"><div className="team-card__photo" role="img" aria-label="Сергей Бежаев"><span>СБ</span><small>ВторМеталл</small></div><h3>Сергей Бежаев</h3><p>Топ-менеджер</p></article>
      </div>
    </section>
