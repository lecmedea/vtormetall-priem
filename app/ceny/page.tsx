...
export default function PricesPage() {
  return <><Header /><main><PageHero eyebrow="Прайс" title="Цена меняется" accent="условия — нет" lead="Настройте категорию, состояние и вес партии. Калькулятор покажет предварительный ориентир, а точную сумму подтвердим после осмотра и взвешивания." ctaHref="#calculator" ctaLabel="Открыть калькулятор" />
    <section className="calculator-section" id="calculator"><div className="shell"><PriceCalculator /></div></section>
